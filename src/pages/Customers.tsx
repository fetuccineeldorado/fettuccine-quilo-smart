...
import AdvancedCustomerManager from "@/components/AdvancedCustomerManager";
...
const Customers = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'management':
        return <AdvancedCustomerManager />;
      case 'reports':
        return (
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Relatórios detalhados de clientes em desenvolvimento...
              </p>
            </CardContent>
          </Card>
        );
      case 'settings':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Configurações de Clientes</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Configurações do sistema de clientes em desenvolvimento...
              </p>
            </CardContent>
          </Card>
        );
    ...
    <DashboardLayout>
      <div className="p-4 lg:p-8 max-w-7xl mx-auto space-y-6 lg:space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
          <div>
            <h1 className="text-2xl lg:text-4xl font-bold mb-2">Clientes</h1>
